...
class KlAardingskabelSectie(KeuzelijstField):
    ...
    options = {
        '10-mm': KeuzelijstWaarde(invulwaarde='10-mm',
                                  label='10 mm²',
                                  status='ingebruik',
                                  definitie='10 mm²',
                                  objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlAardingskabelSectie/10-mm'),
        ...
        '16-mm': KeuzelijstWaarde(invulwaarde='16-mm',
                                  label='16 mm²',
                                  status='ingebruik',
                                  definitie='16 mm²',
                                  objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlAardingskabelSectie/16-mm'),
        ...
        '2-5-mm': KeuzelijstWaarde(invulwaarde='2-5-mm',
                                   label='2.5 mm²',
                                   status='ingebruik',
                                   definitie='2.5 mm²',
                                   objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlAardingskabelSectie/2-5-mm'),
        ...
        '25-mm': KeuzelijstWaarde(invulwaarde='25-mm',
                                  label='25 mm²',
                                  status='ingebruik',
                                  definitie='25 mm²',
                                  objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlAardingskabelSectie/25-mm'),
        ...
        '35-mm': KeuzelijstWaarde(invulwaarde='35-mm',
                                  label='35 mm²',
                                  status='ingebruik',
                                  definitie='35 mm²',
                                  objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlAardingskabelSectie/35-mm'),
        ...
        '4-mm': KeuzelijstWaarde(invulwaarde='4-mm',
                                 label='4 mm²',
                                 status='ingebruik',
                                 definitie='4 mm²',
                                 objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlAardingskabelSectie/4-mm'),
        ...
        '50-mm': KeuzelijstWaarde(invulwaarde='50-mm',
                                  label='50 mm²',
                                  status='ingebruik',
                                  definitie='50 mm²',
                                  objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlAardingskabelSectie/50-mm'),
        ...
        '6-mm': KeuzelijstWaarde(invulwaarde='6-mm',
                                 label='6 mm²',
                                 status='ingebruik',
                                 definitie='6 mm²',
                                 objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlAardingskabelSectie/6-mm'),
