...
from otlmow_model.Datatypes.KlToegangspoortMerk import KlToegangspoortMerk
from otlmow_model.Datatypes.KlToegangspoortModelnaam import KlToegangspoortModelnaam
from otlmow_model.Datatypes.KlToegangspoortType import KlToegangspoortType
...
class Toegangspoort(Toegangselement, AIMNaamObject, PuntGeometrie):
    ...
    def __init__(self):
        ...
        self.add_valid_relation(relation='https://wegenenverkeer.data.vlaanderen.be/ns/onderdeel#HoortBij', target='https://wegenenverkeer.data.vlaanderen.be/ns/installatie#TijdelijkeOpslagplaats')
