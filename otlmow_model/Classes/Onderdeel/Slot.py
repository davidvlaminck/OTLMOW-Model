...
from otlmow_model.Datatypes.KlAlgFaalmodusType import KlAlgFaalmodusType
from otlmow_model.Datatypes.KlSlotGebruik import KlSlotGebruik
from otlmow_model.Datatypes.KlSlotMerk import KlSlotMerk
from otlmow_model.Datatypes.KlSlotModelnaam import KlSlotModelnaam
from otlmow_model.Datatypes.KlSlotType import KlSlotType
...
class Slot(ElektrischComponentennummerObject, SerienummerObject, AIMNaamObject, PuntGeometrie):
    ...
    def __init__(self):
        ...
        self.add_valid_relation(relation='https://wegenenverkeer.data.vlaanderen.be/ns/onderdeel#Bevestiging', target='https://wegenenverkeer.data.vlaanderen.be/ns/onderdeel#Slotcilinder')
