...
from otlmow_model.Datatypes.DtcOlieType import DtcOlieType, DtcOlieTypeWaarden
from otlmow_model.BaseClasses.FloatOrDecimalField import FloatOrDecimalField
from otlmow_model.Datatypes.KlTandwielkastMerk import KlTandwielkastMerk
from otlmow_model.Datatypes.KlTandwielkastModelnaam import KlTandwielkastModelnaam
from otlmow_model.Datatypes.KwantWrdInLiter import KwantWrdInLiter, KwantWrdInLiterWaarden
from otlmow_model.GeometrieTypes.PuntGeometrie import PuntGeometrie


# Generated with OTLClassCreator. To modify: extend, do not edit
class Tandwielkast(AIMNaamObject, SerienummerObject, PuntGeometrie):
    ...
    def __init__(self):
        ...
        self.add_valid_relation(relation='https://wegenenverkeer.data.vlaanderen.be/ns/onderdeel#Bevestiging', target='https://wegenenverkeer.data.vlaanderen.be/ns/onderdeel#Tandwiel')
