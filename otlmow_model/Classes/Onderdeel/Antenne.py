...
from otlmow_model.Datatypes.KlAntenneConstructiefType import KlAntenneConstructiefType
...
class Antenne(Communicatieapparatuur):
    ...
    def __init__(self):
        ...
        self._constructieType = OTLAttribuut(field=KlAntenneConstructiefType,
                                             ...
                                             definition='Het constructief type van de antenne, bepaald door wijze van ophanging.',
                                             owner=self)
        ...
        self._uitvoeringsType = OTLAttribuut(field=KlAntenneUitvoeringsType,
                                             ...
                                             definition='Het uitvoeringstype betreft de werkwijze van de antenne, namelijk of de antenne in 1 (uni) of 2 (bi) richtingen signaal uitstuurt of ontvangt.',
                                             owner=self)

    @property
    def constructieType(self) -> str:
        """Het constructief type van de antenne, bepaald door wijze van ophanging."""
    ...
    def uitvoeringsType(self) -> str:
        """Het uitvoeringstype betreft de werkwijze van de antenne, namelijk of de antenne in 1 (uni) of 2 (bi) richtingen signaal uitstuurt of ontvangt."""
