...
from otlmow_model.Datatypes.KlBouwmethode import KlBouwmethode
from otlmow_model.Datatypes.KlGebruikersType import KlGebruikersType
from otlmow_model.Datatypes.KlTypeOndergrond import KlTypeOndergrond
...
class Kokersectie(AIMObject, VlakGeometrie):
    ...
    def __init__(self):
        ...
        self.add_valid_relation(relation='https://wegenenverkeer.data.vlaanderen.be/ns/onderdeel#Bevestiging', target='https://wegenenverkeer.data.vlaanderen.be/ns/onderdeel#Kokervoeg')
