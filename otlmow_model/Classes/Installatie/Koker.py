...
from otlmow_model.Datatypes.KlBrandwerendeMaatregelen import KlBrandwerendeMaatregelen
from otlmow_model.Datatypes.KlKokerTypeFundering import KlKokerTypeFundering
