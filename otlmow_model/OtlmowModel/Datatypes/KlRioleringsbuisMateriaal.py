...
class KlRioleringsbuisMateriaal(KeuzelijstField):
    ...
    options = {
        ...
        'hdpe': KeuzelijstWaarde(invulwaarde='hdpe',
                                 ...
                                 status='ingebruik',
                                 definitie='HDPE',
                                 objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlRioleringsbuisMateriaal/hdpe'),
        ...
        'rvs': KeuzelijstWaarde(invulwaarde='rvs',
                                label='RVS',
                                status='ingebruik',
                                definitie='Roestvast staal - Inox',
                                objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlRioleringsbuisMateriaal/rvs'),
