...
class KlLEDDriverModelnaam(KeuzelijstField):
    ...
    options = {
        ...
        'eum-320s105bg': KeuzelijstWaarde(invulwaarde='eum-320s105bg',
                                          label='EUM-320S105BG',
                                          status='ingebruik',
                                          definitie='EUM-320S105BG',
                                          objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlLEDDriverModelnaam/eum-320s105bg'),
        ...
        'slc-g3-r3-sp0b-p0': KeuzelijstWaarde(invulwaarde='slc-g3-r3-sp0b-p0',
                                              label='SLC-G3-R3-SP0B-P0',
                                              status='ingebruik',
                                              definitie='SLC-G3-R3-SP0B-P0',
                                              objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlLEDDriverModelnaam/slc-g3-r3-sp0b-p0'),
        'slc-g3-r3-sp0b-pm': KeuzelijstWaarde(invulwaarde='slc-g3-r3-sp0b-pm',
                                              label='SLC-G3-R3-SP0B-PM',
                                              status='ingebruik',
                                              definitie='SLC-G3-R3-SP0B-PM',
                                              objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlLEDDriverModelnaam/slc-g3-r3-sp0b-pm'),
        'xi-fp-110w-0-2-0-7a-snldae-230v-c133-sxt': KeuzelijstWaarde(invulwaarde='xi-fp-110w-0-2-0-7a-snldae-230v-c133-sxt',
                                                                     label='Xi FP 110W 0.2-0.7A SNLDAE 230V C133 sXt',
                                                                     status='ingebruik',
                                                                     definitie='Xi FP 110W 0.2-0.7A SNLDAE 230V C133 sXt',
                                                                     objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlLEDDriverModelnaam/xi-fp-110w-0-2-0-7a-snldae-230v-c133-sxt'),
        'xi-fp-75w-0-2-0-7a-snldae-230v-c133-sxt': KeuzelijstWaarde(invulwaarde='xi-fp-75w-0-2-0-7a-snldae-230v-c133-sxt',
                                                                    label='Xi FP 75W 0.2-0.7A SNLDAE 230V C133 sXt',
                                                                    status='ingebruik',
                                                                    definitie='Xi FP 75W 0.2-0.7A SNLDAE 230V C133 sXt',
                                                                    objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlLEDDriverModelnaam/xi-fp-75w-0-2-0-7a-snldae-230v-c133-sxt'),
