...
class KlOmvormerModelnaam(KeuzelijstField):
    ...
    options = {
        ...
        'lrp-101ue': KeuzelijstWaarde(invulwaarde='lrp-101ue',
                                      label='LRP-101UE',
                                      status='ingebruik',
                                      definitie='LRP-101UE',
                                      objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlOmvormerModelnaam/lrp-101ue'),
        'lrp-101uh': KeuzelijstWaarde(invulwaarde='lrp-101uh',
                                      label='LRP-101UH',
                                      status='ingebruik',
                                      definitie='LRP-101UH',
                                      objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlOmvormerModelnaam/lrp-101uh'),
        ...
        'poe-163': KeuzelijstWaarde(invulwaarde='poe-163',
                                    label='POE-163',
                                    status='ingebruik',
                                    definitie='POE-163',
                                    objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlOmvormerModelnaam/poe-163'),
