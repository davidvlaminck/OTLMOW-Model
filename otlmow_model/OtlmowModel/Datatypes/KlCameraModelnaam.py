...
class KlCameraModelnaam(KeuzelijstField):
    ...
    options = {
        ...
        'dual': KeuzelijstWaarde(invulwaarde='dual',
                                 ...
                                 status='ingebruik',
                                 definitie='dual',
                                 objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlCameraModelnaam/dual'),
        ...
        'g1': KeuzelijstWaarde(invulwaarde='g1',
                               ...
                               status='ingebruik',
                               definitie='G1',
                               objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlCameraModelnaam/g1'),
        ...
        'q6355-le': KeuzelijstWaarde(invulwaarde='q6355-le',
                                     label='Q6355-LE',
                                     status='ingebruik',
                                     definitie='Q6355-LE',
                                     objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlCameraModelnaam/q6355-le'),
        'qcam3': KeuzelijstWaarde(invulwaarde='qcam3',
                                  label='QCAM3',
                                  status='ingebruik',
                                  definitie='QCAM3',
                                  objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlCameraModelnaam/qcam3'),
        'qcam5': KeuzelijstWaarde(invulwaarde='qcam5',
                                  label='QCAM5',
                                  status='ingebruik',
                                  definitie='QCAM5',
                                  objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlCameraModelnaam/qcam5'),
        ...
        'trafibot-dual-ai': KeuzelijstWaarde(invulwaarde='trafibot-dual-ai',
                                             label='Trafibot DUAL AI',
                                             status='ingebruik',
                                             definitie='Trafibot DUAL AI',
                                             objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlCameraModelnaam/trafibot-dual-ai'),
        ...
        'vega': KeuzelijstWaarde(invulwaarde='vega',
                                 ...
                                 status='ingebruik',
                                 definitie='Vega',
                                 objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlCameraModelnaam/vega'),
