...
class KlNetwerkkaartModelnaam(KeuzelijstField):
    ...
    options = {
        ...
        'cn-100-a80': KeuzelijstWaarde(invulwaarde='cn-100-a80',
                                       label='CN-100-A80',
                                       status='ingebruik',
                                       definitie='CN-100-A80',
                                       objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlNetwerkkaartModelnaam/cn-100-a80'),
        'dcad-1': KeuzelijstWaarde(invulwaarde='dcad-1',
                                   label='DCAD-1',
                                   status='ingebruik',
                                   definitie='OTN CWDM filter met 1 kanaal Edge Optical',
                                   objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlNetwerkkaartModelnaam/dcad-1'),
        'dcad-2': KeuzelijstWaarde(invulwaarde='dcad-2',
                                   label='DCAD-2',
                                   status='ingebruik',
                                   definitie='OTN CWDM filter met 2 kanalen Edge Optical',
                                   objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlNetwerkkaartModelnaam/dcad-2'),
        'dcad-4': KeuzelijstWaarde(invulwaarde='dcad-4',
                                   label='DCAD-4',
                                   status='ingebruik',
                                   definitie='OTN CWDM filter met 4 kanalen Edge Optical',
                                   objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlNetwerkkaartModelnaam/dcad-4'),
        ...
        'dcmd-8he': KeuzelijstWaarde(invulwaarde='dcmd-8he',
                                     label='DCMD-8HE',
                                     status='ingebruik',
                                     definitie='DCMD-8HE',
                                     objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlNetwerkkaartModelnaam/dcmd-8he'),
        ...
        'ddmd-8-2532': KeuzelijstWaarde(invulwaarde='ddmd-8-2532',
                                        label='DDMD-8-2532',
                                        status='ingebruik',
                                        definitie='OTN DWDM filter met 8 kanalen Edge Optical',
                                        objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlNetwerkkaartModelnaam/ddmd-8-2532'),
        ...
        't-oadm-2-4': KeuzelijstWaarde(invulwaarde='t-oadm-2-4',
                                       label='T-OADM-2-4',
                                       status='ingebruik',
                                       definitie='OTN CWDM filter met 1 kanaal Smartoptics',
                                       objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlNetwerkkaartModelnaam/t-oadm-2-4')
    }
