...
class KlTypeBrugdeel(KeuzelijstField):
    ...
    options = {
        ...
        'integraalbrug': KeuzelijstWaarde(invulwaarde='integraalbrug',
                                          label='integraalbrug',
                                          status='ingebruik',
                                          definitie='Een specifiek type brug waarbij het rijdek monoliet is verbonden aan de onderliggende constructie (onderbouw).',
                                          objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlTypeBrugdeel/integraalbrug'),
