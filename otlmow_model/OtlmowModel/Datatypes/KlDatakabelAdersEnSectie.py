...
class KlDatakabelAdersEnSectie(KeuzelijstField):
    ...
    options = {
        ...
        '3g0-75': KeuzelijstWaarde(invulwaarde='3g0-75',
                                   label='3G0.75',
                                   status='ingebruik',
                                   definitie='3G0.75',
                                   objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlDatakabelAdersEnSectie/3g0-75'),
        '3x1-5': KeuzelijstWaarde(invulwaarde='3x1-5',
                                  label='3x1.5',
                                  status='ingebruik',
                                  definitie='3x1.5',
                                  objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlDatakabelAdersEnSectie/3x1-5'),
        ...
        '4x1-5': KeuzelijstWaarde(invulwaarde='4x1-5',
                                  ...
                                  status='ingebruik',
                                  definitie='4x1.5',
                                  objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlDatakabelAdersEnSectie/4x1-5'),
        '4x2x0-34': KeuzelijstWaarde(invulwaarde='4x2x0-34',
                                     label='4x2x0.34',
                                     status='ingebruik',
                                     definitie='4x2x0.34',
                                     objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlDatakabelAdersEnSectie/4x2x0-34'),
        '4x2x0-5': KeuzelijstWaarde(invulwaarde='4x2x0-5',
                                    label='4x2x0.5',
                                    status='ingebruik',
                                    definitie='4x2x0.5',
                                    objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlDatakabelAdersEnSectie/4x2x0-5'),
        ...
        '5g1': KeuzelijstWaarde(invulwaarde='5g1',
                                label='5G1',
                                status='ingebruik',
                                definitie='5G1',
                                objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlDatakabelAdersEnSectie/5g1'),
        '8x0-25': KeuzelijstWaarde(invulwaarde='8x0-25',
                                   label='8x0.25',
                                   status='ingebruik',
                                   definitie='8x0.25',
                                   objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlDatakabelAdersEnSectie/8x0-25'),
