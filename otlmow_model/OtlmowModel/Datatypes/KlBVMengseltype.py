...
class KlBVMengseltype(KeuzelijstField):
    ...
    options = {
        ...
        'agt': KeuzelijstWaarde(invulwaarde='agt',
                                label='AGT',
                                status='ingebruik',
                                definitie='AGT',
                                objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlBVMengseltype/agt'),
        'ahv-b2': KeuzelijstWaarde(invulwaarde='ahv-b2',
                                   label='AHV-B2',
                                   status='ingebruik',
                                   definitie='AHV-B2',
                                   objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlBVMengseltype/ahv-b2'),
        ...
        'peo-a': KeuzelijstWaarde(invulwaarde='peo-a',
                                  label='PEO-A',
                                  status='ingebruik',
                                  definitie='PEO-A',
                                  objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlBVMengseltype/peo-a'),
        'pet-a': KeuzelijstWaarde(invulwaarde='pet-a',
                                  label='PET-A',
                                  status='ingebruik',
                                  definitie='PET-A',
                                  objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlBVMengseltype/pet-a'),
        'sme-d1': KeuzelijstWaarde(invulwaarde='sme-d1',
                                   label='SME-D1',
                                   status='ingebruik',
                                   definitie='SME-D1',
                                   objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlBVMengseltype/sme-d1'),
        'sme-d2': KeuzelijstWaarde(invulwaarde='sme-d2',
                                   label='SME-D2',
                                   status='ingebruik',
                                   definitie='SME-D2',
                                   objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlBVMengseltype/sme-d2'),
