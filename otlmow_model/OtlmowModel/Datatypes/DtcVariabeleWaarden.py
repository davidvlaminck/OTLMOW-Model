...
class DtcVariabeleWaardenWaarden(WaardenObject):
    def __init__(self):
        ...
        self._codelijst = OTLAttribuut(field=KlVariabeleWaarden,
                                       naam='codelijst',
                                       label='codelijst',
                                       objectUri='https://data.vlaanderen.be/ns/projecten#DtcVariabeleWaarden.codelijst',
        ...
        self._datum = OTLAttribuut(field=DateField,
                                   naam='datum',
                                   label='datum',
                                   objectUri='https://data.vlaanderen.be/ns/projecten#DtcVariabeleWaarden.datum',
        ...
        self._getal = OTLAttribuut(field=FloatOrDecimalField,
                                   naam='getal',
                                   label='getal',
                                   objectUri='https://data.vlaanderen.be/ns/projecten#DtcVariabeleWaarden.getal',
        ...
        self._tekst = OTLAttribuut(field=StringField,
                                   naam='tekst',
                                   label='tekst',
                                   objectUri='https://data.vlaanderen.be/ns/projecten#DtcVariabeleWaarden.tekst',
...
class DtcVariabeleWaarden(ComplexField):
    ...
    objectUri = 'https://data.vlaanderen.be/ns/projecten#DtcVariabeleWaarden'
