...
class KlIVRIBaseline(KeuzelijstField):
    ...
    options = {
        ...
        'idd-ris-fi-version-2-0-2': KeuzelijstWaarde(invulwaarde='idd-ris-fi-version-2-0-2',
                                                     label='IDD RIS-FI version 2.0.2',
                                                     status='ingebruik',
                                                     definitie='IDD RIS-FI version 2.0.2',
                                                     objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlIVRIBaseline/idd-ris-fi-version-2-0-2'),
