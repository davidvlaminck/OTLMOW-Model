...
class KlToegangspoortMerk(KeuzelijstField):
    ...
    options = {
        ...
        'lenaers': KeuzelijstWaarde(invulwaarde='lenaers',
                                    label='Lenaers',
                                    status='ingebruik',
                                    definitie='Lenaers',
                                    objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlToegangspoortMerk/lenaers'),
        'nassau': KeuzelijstWaarde(invulwaarde='nassau',
                                   label='Nassau',
                                   status='ingebruik',
                                   definitie='Nassau',
                                   objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlToegangspoortMerk/nassau'),
