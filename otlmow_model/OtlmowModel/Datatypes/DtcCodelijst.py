...
class DtcCodelijstWaarden(WaardenObject):
    def __init__(self):
        ...
        self._codelijstType = OTLAttribuut(field=KlCodelijstType,
                                           ...
                                           objectUri='https://data.vlaanderen.be/ns/projecten#DtcCodelijst.codelijstType',
                                           definition='TODO',
                                           owner=self)
        ...
        self._naam = OTLAttribuut(field=StringField,
                                  naam='naam',
                                  label='naam',
                                  objectUri='https://data.vlaanderen.be/ns/projecten#DtcCodelijst.naam',
                                  definition='TODO',
                                  owner=self)
...
class DtcCodelijst(ComplexField):
    ...
    naam = 'DtcCodelijst'
    label = 'Codelijst'
    objectUri = 'https://data.vlaanderen.be/ns/projecten#DtcCodelijst'
    definition = 'TODO'
