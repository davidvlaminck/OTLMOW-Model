...
class KlArmatuurkleur(KeuzelijstField):
    ...
    options = {
        ...
        'ral-7012': KeuzelijstWaarde(invulwaarde='ral-7012',
                                     label='RAL 7012',
                                     status='ingebruik',
                                     definitie='RAL 7012',
                                     objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlArmatuurkleur/ral-7012'),
        'ral-7016': KeuzelijstWaarde(invulwaarde='ral-7016',
                                     label='RAL 7016',
                                     status='ingebruik',
                                     definitie='RAL 7016',
                                     objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlArmatuurkleur/ral-7016'),
        'ral-7017': KeuzelijstWaarde(invulwaarde='ral-7017',
                                     label='RAL 7017',
                                     status='ingebruik',
                                     definitie='Donkerbruin',
                                     objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlArmatuurkleur/ral-7017'),
