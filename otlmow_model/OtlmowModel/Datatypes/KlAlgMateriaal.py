...
class KlAlgMateriaal(KeuzelijstField):
    ...
    options = {
        ...
        'gietmortel': KeuzelijstWaarde(invulwaarde='gietmortel',
                                       label='gietmortel',
                                       status='ingebruik',
                                       definitie='gietmortel',
                                       objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlAlgMateriaal/gietmortel'),
        ...
        'polystyreen': KeuzelijstWaarde(invulwaarde='polystyreen',
                                        label='polystyreen',
                                        status='ingebruik',
                                        definitie='polystyreen',
                                        objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlAlgMateriaal/polystyreen'),
