...
class KlNetwerkelemGebruik(KeuzelijstField):
    ...
    options = {
        ...
        'hdsl-modem': KeuzelijstWaarde(invulwaarde='hdsl-modem',
                                       label='HDSL-modem',
                                       status='ingebruik',
                                       definitie='Een HDSL modem.',
                                       objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlNetwerkelemGebruik/hdsl-modem'),
        ...
        'wdm': KeuzelijstWaarde(invulwaarde='wdm',
                                label='WDM',
                                status='ingebruik',
                                definitie='Wave Division Multiplexing MUX netwerk elementen',
                                objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlNetwerkelemGebruik/wdm'),
