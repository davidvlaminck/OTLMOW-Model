...
class KlMarkeringWaarborgperiode(KeuzelijstField):
    ...
    options = {
        ...
        '5-jaar': KeuzelijstWaarde(invulwaarde='5-jaar',
                                   label='5 jaar',
                                   status='ingebruik',
                                   definitie='Waarborgperiode van 5 jaar.',
                                   objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlMarkeringWaarborgperiode/5-jaar'),
