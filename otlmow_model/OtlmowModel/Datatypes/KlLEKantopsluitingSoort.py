...
class KlLEKantopsluitingSoort(KeuzelijstField):
    ...
    options = {
        ...
        'betonnen-perronbanden': KeuzelijstWaarde(invulwaarde='betonnen-perronbanden',
                                                  label='betonnen perronbanden',
                                                  status='ingebruik',
                                                  definitie='Perronbanden of bushaltebanden maken het mogelijk om passagiers gemakkelijk en vooral veilig te laten in- en uitstappen. ',
                                                  objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlLEKantopsluitingSoort/betonnen-perronbanden'),
