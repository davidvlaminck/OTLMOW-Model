...
class KlUPSModelnaam(KeuzelijstField):
    ...
    options = {
        ...
        'srvpm1kril-e': KeuzelijstWaarde(invulwaarde='srvpm1kril-e',
                                         label='SRVPM1KRIL-E',
                                         status='ingebruik',
                                         definitie='SRVPM1KRIL-E',
                                         objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlUPSModelnaam/srvpm1kril-e'),
