...
class KlPersleidingMateriaal(KeuzelijstField):
    ...
    options = {
        ...
        'buizen-van-galva-voor-hydranten': KeuzelijstWaarde(invulwaarde='buizen-van-galva-voor-hydranten',
                                                            label='buizen van GALVA voor hydranten',
                                                            status='ingebruik',
                                                            definitie='buizen van GALVA voor hydranten.',
                                                            objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlPersleidingMateriaal/buizen-van-galva-voor-hydranten'),
        ...
        'buizen-van-koolstofstaal': KeuzelijstWaarde(invulwaarde='buizen-van-koolstofstaal',
                                                     label='buizen van koolstofstaal',
                                                     status='ingebruik',
                                                     definitie='buizen van koolstofstaal',
                                                     objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlPersleidingMateriaal/buizen-van-koolstofstaal'),
        ...
        'buizen-van-staal': KeuzelijstWaarde(invulwaarde='buizen-van-staal',
                                             label='buizen van staal',
                                             status='ingebruik',
                                             definitie='buizen van staal',
                                             objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlPersleidingMateriaal/buizen-van-staal'),
