...
class KlNetwerkMerk(KeuzelijstField):
    ...
    options = {
        ...
        'mtx': KeuzelijstWaarde(invulwaarde='mtx',
                                label='MTX',
                                status='ingebruik',
                                definitie='MTX',
                                objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlNetwerkMerk/mtx'),
        'oring': KeuzelijstWaarde(invulwaarde='oring',
                                  label='Oring',
                                  status='ingebruik',
                                  definitie='Oring',
                                  objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlNetwerkMerk/oring'),
        'smartoptics': KeuzelijstWaarde(invulwaarde='smartoptics',
                                        label='Smartoptics',
                                        status='ingebruik',
                                        definitie='Smartoptics',
                                        objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlNetwerkMerk/smartoptics'),
        'teltonika': KeuzelijstWaarde(invulwaarde='teltonika',
                                      label='Teltonika',
                                      status='ingebruik',
                                      definitie='Teltonika',
                                      objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlNetwerkMerk/teltonika'),
