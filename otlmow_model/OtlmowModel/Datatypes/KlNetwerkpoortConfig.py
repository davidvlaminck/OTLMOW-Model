...
class KlNetwerkpoortConfig(KeuzelijstField):
    ...
    options = {
        ...
        '200ge': KeuzelijstWaarde(invulwaarde='200ge',
                                  label='200GE',
                                  status='ingebruik',
                                  definitie='Ethernet verbinding met bandbreedte van 200 Gb/s',
                                  objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlNetwerkpoortConfig/200ge'),
        '400ge': KeuzelijstWaarde(invulwaarde='400ge',
                                  label='400GE',
                                  status='ingebruik',
                                  definitie='Ethernet verbinding met bandbreedte van 400 Gb/s',
                                  objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlNetwerkpoortConfig/400ge'),
        ...
        '800ge': KeuzelijstWaarde(invulwaarde='800ge',
                                  label='800GE',
                                  status='ingebruik',
                                  definitie='Ethernet verbinding met bandbreedte van 800 Gb/s',
                                  objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlNetwerkpoortConfig/800ge'),
