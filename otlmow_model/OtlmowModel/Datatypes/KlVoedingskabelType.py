...
class KlVoedingskabelType(KeuzelijstField):
    ...
    options = {
        ...
        'olflex': KeuzelijstWaarde(invulwaarde='olflex',
                                   ...
                                   status='ingebruik',
                                   definitie='Ölflex',
                                   objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlVoedingskabelType/olflex'),
        'svav': KeuzelijstWaarde(invulwaarde='svav',
                                 label='SVAV',
                                 status='ingebruik',
                                 definitie='SVAV',
                                 objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlVoedingskabelType/svav'),
