...
class KlWvLedLichtpunthoogte(KeuzelijstField):
    ...
    options = {
        ...
        '12': KeuzelijstWaarde(invulwaarde='12',
                               ...
                               status='ingebruik',
                               definitie='12',
                               objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlWvLedLichtpunthoogte/12'),
        ...
        '2': KeuzelijstWaarde(invulwaarde='2',
                              ...
                              status='ingebruik',
                              definitie='2',
                              objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlWvLedLichtpunthoogte/2'),
        '2-5': KeuzelijstWaarde(invulwaarde='2-5',
                                label='2.5',
                                status='ingebruik',
                                definitie='2.5',
                                objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlWvLedLichtpunthoogte/2-5'),
        '2-73': KeuzelijstWaarde(invulwaarde='2-73',
                                 label='2.73',
                                 status='ingebruik',
                                 definitie='2m73 boven de rijweg',
                                 objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlWvLedLichtpunthoogte/2-73'),
        ...
        '5-2': KeuzelijstWaarde(invulwaarde='5-2',
                                label='5.2',
                                status='ingebruik',
                                definitie='5,2',
                                objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlWvLedLichtpunthoogte/5-2'),
        '6': KeuzelijstWaarde(invulwaarde='6',
                              label='6',
                              status='ingebruik',
                              definitie='6',
                              objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlWvLedLichtpunthoogte/6'),
