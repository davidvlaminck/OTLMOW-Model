...
class KlThermoHygrometerModelnaam(KeuzelijstField):
    ...
    options = {
        ...
        'dtr13': KeuzelijstWaarde(invulwaarde='dtr13',
                                  label='DTR13',
                                  status='ingebruik',
                                  definitie='DTR13',
                                  objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlThermoHygrometerModelnaam/dtr13'),
        ...
        'hmp155e': KeuzelijstWaarde(invulwaarde='hmp155e',
                                    label='HMP155E',
                                    status='ingebruik',
                                    definitie='HMP155E',
                                    objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlThermoHygrometerModelnaam/hmp155e'),
        'hmp45': KeuzelijstWaarde(invulwaarde='hmp45',
                                  label='HMP45',
                                  status='ingebruik',
                                  definitie='HMP45',
                                  objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlThermoHygrometerModelnaam/hmp45'),
