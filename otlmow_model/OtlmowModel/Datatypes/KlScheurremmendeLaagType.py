...
class KlScheurremmendeLaagType(KeuzelijstField):
    ...
    options = {
        ...
        'glasvlies': KeuzelijstWaarde(invulwaarde='glasvlies',
                                      label='glasvlies',
                                      status='ingebruik',
                                      definitie='Een dun, sterk materiaal gemaakt van zeer fijne glasvezels die tot een vlies zijn geperst.',
                                      objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlScheurremmendeLaagType/glasvlies'),
