...
from ...Classes.Abstracten.Betonfundering import Betonfundering
...
class Verankeringsmassief(Betonfundering, KlassiekeFundering):
    ...
    def __init__(self):
        ...
        self.add_valid_relation(relation='https://wegenenverkeer.data.vlaanderen.be/ns/onderdeel#Bevestiging', target='https://wegenenverkeer.data.vlaanderen.be/ns/onderdeel#OmegaElement', direction='u', deprecated='2.5.0')  # u = unidirectional
