...
class Rolwagenchassis(TechnischDocument, AIMNaamObject, PuntGeometrie):
    """De staalconstructie die de verschillende onderdelen van de rolwagen met elkaar verbindt."""

    typeURI = 'https://wegenenverkeer.data.vlaanderen.be/ns/onderdeel#Rolwagenchassis'
