...
class FunderingOpStaal(KlassiekeFundering, PuntGeometrie, VlakGeometrie):
    """Fundering die direct op de draagkrachtige bodem rust. Kunnen uitgevoerd zijn als alleenstaande zolen of als doorlopende stroken."""

    typeURI = 'https://wegenenverkeer.data.vlaanderen.be/ns/onderdeel#FunderingOpStaal'
