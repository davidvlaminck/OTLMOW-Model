...
class SoilmixwandElement(Funderingspaal):
    """In de grond gevormde paal of paneel uit grout gemixt met de grond."""

    typeURI = 'https://wegenenverkeer.data.vlaanderen.be/ns/onderdeel#SoilmixwandElement'
    ...
    def __init__(self):
        ...
        self.add_valid_relation(relation='https://wegenenverkeer.data.vlaanderen.be/ns/onderdeel#HoortBij', target='https://wegenenverkeer.data.vlaanderen.be/ns/installatie#Soilmixwand', direction='o')  # o = direction: outgoing
        ...
        self._rekennota = OTLAttribuut(field=DtcDocument,
                                       naam='rekennota',
                                       label='rekennota',
                                       objectUri='https://wegenenverkeer.data.vlaanderen.be/ns/onderdeel#SoilmixwandElement.rekennota',
                                       definition='De spanning waarbij het materiaal onder invloed van (druk)belasting bezwijkt (karakteristieke waarde).',
                                       owner=self)

    @property
    def rekennota(self) -> DtcDocumentWaarden:
        """De spanning waarbij het materiaal onder invloed van (druk)belasting bezwijkt (karakteristieke waarde)."""
