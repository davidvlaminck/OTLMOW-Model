...
class Veerhuis(TechnischDocument, AIMNaamObject, PuntGeometrie):
    """Een behuizing rond een veer of verenpakket die als bescherming dient."""

    typeURI = 'https://wegenenverkeer.data.vlaanderen.be/ns/onderdeel#Veerhuis'
    ...
    def __init__(self):
        ...
        self.add_valid_relation(relation='https://wegenenverkeer.data.vlaanderen.be/ns/onderdeel#Omhult', target='https://wegenenverkeer.data.vlaanderen.be/ns/onderdeel#Verenpakket', direction='o')  # o = direction: outgoing
