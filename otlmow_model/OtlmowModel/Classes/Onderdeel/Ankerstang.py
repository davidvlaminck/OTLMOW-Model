...
class Ankerstang(StaalsoortObject, TechnischDocument, AIMNaamObject, PuntGeometrie):
    """Een onderdeel dat wordt gebruikt om krachten over te dragen tussen een constructie of mechanisme en een vast ankerpunt."""

    typeURI = 'https://wegenenverkeer.data.vlaanderen.be/ns/onderdeel#Ankerstang'
