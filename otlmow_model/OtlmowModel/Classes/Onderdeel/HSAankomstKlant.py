...
class HSAankomstKlant(NaampadObject, PuntGeometrie):
    """Functionele Unit (FU) van de HS-cellen waarop de HS-netkabel van de districbutienetbeheerder in de kopcabine aankomt in de klantcabine."""

    typeURI = 'https://wegenenverkeer.data.vlaanderen.be/ns/onderdeel#HSAankomstKlant'
    ...
    def __init__(self):
        ...
        self.add_valid_relation(relation='https://wegenenverkeer.data.vlaanderen.be/ns/onderdeel#Voedt', target='https://wegenenverkeer.data.vlaanderen.be/ns/onderdeel#HSVertrekKlant', direction='i')  # i = direction: incoming
