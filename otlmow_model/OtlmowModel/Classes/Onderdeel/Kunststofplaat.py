...
class Kunststofplaat(KunststofConstructieObject):
    ...
    def __init__(self):
        ...
        self._dikte = OTLAttribuut(field=KwantWrdInCentimeter,
                                   naam='dikte',
                                   label='dikte',
                                   objectUri='https://wegenenverkeer.data.vlaanderen.be/ns/onderdeel#Kunststofplaat.dikte',
                                   definition='De dikte van de kunststof plaat uitgedrukt in centimeter.',
                                   owner=self)

    @property
    def dikte(self) -> KwantWrdInCentimeterWaarden:
        """De dikte van de kunststof plaat uitgedrukt in centimeter."""
