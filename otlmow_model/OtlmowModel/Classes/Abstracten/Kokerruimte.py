...
class Kokerruimte(VlakGeometrie):
    """Een abstracte en overkoepelende klasse. Het is een ruimte van het kokercomplex die geen doorvoerende functie heeft."""

    typeURI = 'https://wegenenverkeer.data.vlaanderen.be/ns/abstracten#Kokerruimte'
    ...
    def __init__(self):
        ...
        self.add_valid_relation(relation='https://wegenenverkeer.data.vlaanderen.be/ns/onderdeel#Bevestiging', target='https://wegenenverkeer.data.vlaanderen.be/ns/installatie#Trappentoren', direction='u', deprecated='2.12.0')  # u = unidirectional
