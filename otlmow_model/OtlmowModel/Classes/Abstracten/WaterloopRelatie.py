...
from ...Datatypes.KlWaterloopVhagCode import KlWaterloopVhagCode
from otlmow_model.OtlmowModel.GeometrieTypes.VlakGeometrie import VlakGeometrie


# Generated with OTLClassCreator. To modify: extend, do not edit
class WaterloopRelatie(AIMNaamObject, VlakGeometrie):
    """Abstracte om de gemeenschappelijke relaties van de verschillende soorten waterlopen onder 1 noemer te houden."""

    typeURI = 'https://wegenenverkeer.data.vlaanderen.be/ns/abstracten#WaterloopRelatie'
    ...
    def __init__(self):
        ...
        self.add_valid_relation(relation='https://wegenenverkeer.data.vlaanderen.be/ns/onderdeel#HoortBij', target='https://wegenenverkeer.data.vlaanderen.be/ns/installatie#Ecoduiker')
        self.add_valid_relation(relation='https://wegenenverkeer.data.vlaanderen.be/ns/onderdeel#HoortBij', target='https://wegenenverkeer.data.vlaanderen.be/ns/installatie#Ecovallei')
        ...
        self.add_valid_relation(relation='https://wegenenverkeer.data.vlaanderen.be/ns/onderdeel#HoortBij', target='https://wegenenverkeer.data.vlaanderen.be/ns/installatie#Wegberm', deprecated='2.11.0-RC1')
        ...
        self._vhagCode = OTLAttribuut(field=KlWaterloopVhagCode,
                                      naam='vhagCode',
                                      label='vhag code',
                                      objectUri='https://wegenenverkeer.data.vlaanderen.be/ns/abstracten#WaterloopRelatie.vhagCode',
                                      definition='Identificatiecode voor een VHA-waterloop binnen het Vlaams Gewest waartoe het segment behoort. Een VHA-waterloop is een reële waterloop van bron (punt-van-oorsprong) tot monding (voor zover binnen Vlaanderen gelegen).',
                                      owner=self)

    @property
    def vhagCode(self) -> str:
        """Identificatiecode voor een VHA-waterloop binnen het Vlaams Gewest waartoe het segment behoort. Een VHA-waterloop is een reële waterloop van bron (punt-van-oorsprong) tot monding (voor zover binnen Vlaanderen gelegen)."""
        return self._vhagCode.get_waarde()

    @vhagCode.setter
    def vhagCode(self, value):
        self._vhagCode.set_waarde(value, owner=self)
