...
class PictogramSV(Concept):
    """TODO"""

    typeURI = 'https://data.vlaanderen.be/ns/mobiliteit#Pictogram'
    ...
    def __init__(self):
        ...
        self._afbeelding = OTLAttribuut(field=DtcDocument,
                                        naam='afbeelding',
                                        label='afbeelding',
                                        objectUri='https://data.vlaanderen.be/ns/mobiliteit#Pictogram.afbeelding',
                                        definition='TODO',
                                        owner=self)
