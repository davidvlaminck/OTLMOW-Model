...
class Wegmarkeringconcept(Verkeerstekenconcept):
    ...
    def __init__(self):
        ...
        self.add_valid_relation(relation='http://www.w3.org/ns/prov#wasDerivedFrom', target='https://data.vlaanderen.be/ns/mobiliteit#WegmarkeringVerkeersteken', direction='i')  # i = direction: incoming
