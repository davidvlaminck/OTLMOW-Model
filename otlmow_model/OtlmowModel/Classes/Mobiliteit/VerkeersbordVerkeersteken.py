...
class VerkeersbordVerkeersteken(Verkeersteken):
    ...
    def __init__(self):
        ...
        self.add_valid_relation(relation='http://www.w3.org/ns/prov#wasDerivedFrom', target='https://data.vlaanderen.be/ns/mobiliteit#Verkeersbordconcept', direction='o')  # o = direction: outgoing
        ...
        self.add_valid_relation(relation='https://data.vlaanderen.be/ns/mobiliteit#heeftOnderbord', target='https://data.vlaanderen.be/ns/mobiliteit#VerkeersbordVerkeersteken', direction='o')  # o = direction: outgoing
