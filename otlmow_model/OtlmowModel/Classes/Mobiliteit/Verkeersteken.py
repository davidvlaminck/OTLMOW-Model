...
class Verkeersteken(LinkObjectSV):
    ...
    def __init__(self):
        ...
        self.add_valid_relation(relation='https://data.vlaanderen.be/ns/mobiliteit#AanvullendReglementOntwerp.heeftOntwerp', target='https://data.vlaanderen.be/ns/mobiliteit#OntwerpVerkeersteken', direction='o')  # o = direction: outgoing
        ...
        self.add_valid_relation(relation='https://data.vlaanderen.be/ns/mobiliteit#wordtAangeduidDoor', target='https://data.vlaanderen.be/ns/mobiliteit#Mobiliteitsmaatregel', direction='i')  # i = direction: incoming
        self.add_valid_relation(relation='https://data.vlaanderen.be/ns/mobiliteit#wordtAangeduidDoor', target='https://data.vlaanderen.be/ns/mobiliteit#MobliteitsmaatregelOntwerp', direction='u')  # u = unidirectional
