...
class WegverlichtingGroep(NaampadObject, PuntGeometrie):
    """Groepstype voor het groeperen van WVLichtmast, WVConsole, WVBevestigd."""

    typeURI = 'https://wegenenverkeer.data.vlaanderen.be/ns/installatie#WegverlichtingGroep'
    ...
    def __init__(self):
        ...
        self.add_valid_relation(relation='https://wegenenverkeer.data.vlaanderen.be/ns/onderdeel#HoortBij', target='https://wegenenverkeer.data.vlaanderen.be/ns/onderdeel#WVBevestigd', direction='i')  # i = direction: incoming
        self.add_valid_relation(relation='https://wegenenverkeer.data.vlaanderen.be/ns/onderdeel#HoortBij', target='https://wegenenverkeer.data.vlaanderen.be/ns/onderdeel#WVConsole', direction='i')  # i = direction: incoming
