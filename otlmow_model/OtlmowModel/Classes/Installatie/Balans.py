...
class Balans(ConstructiefObject, VlakGeometrie):
    """Een balans is een hoofdconstructieonderdeel van een beweegbare brug, type ophaalbrug. Klassiek bestaat het uit: twee balansarmen en hun onderlinge verbinding(en) met aan één zijde twee trekkers en aan de andere zijde een tegengewicht(kist). Een balans wordt scharnierend verankerd aan de bovenzijde van een hameipoort of aan die van (twee) hameistijlen. Dankzij dit onderdeel kan het met de trekkers verbonden val (ook 'klap') met het tegengewicht zodanig gebalanceerd worden, dat er weinig arbeid moet geleverd worden om dit brugdeel eenzijdig te kunnen lichten van zijn oplegging."""

    typeURI = 'https://wegenenverkeer.data.vlaanderen.be/ns/installatie#Balans'
    ...
    def __init__(self):
        ...
        self.add_valid_relation(relation='https://wegenenverkeer.data.vlaanderen.be/ns/onderdeel#HoortBij', target='https://wegenenverkeer.data.vlaanderen.be/ns/installatie#Balansarm', direction='i')  # i = direction: incoming
        ...
        self._isGevuldMetTegengewicht = OTLAttribuut(field=BooleanField,
                                                     ...
                                                     objectUri='https://wegenenverkeer.data.vlaanderen.be/ns/installatie#Balans.isGevuldMetTegengewicht',
                                                     definition='Aanduiding of de balans al dan niet gevuld is met een tegengewicht.',
                                                     owner=self)

    @property
    def isGevuldMetTegengewicht(self) -> bool:
        """Aanduiding of de balans al dan niet gevuld is met een tegengewicht."""
