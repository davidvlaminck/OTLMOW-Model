...
class Z30Groep(NaampadObject, PuntGeometrie):
    """Type dat alle assets omvat die bij een zone 30 horen."""

    typeURI = 'https://wegenenverkeer.data.vlaanderen.be/ns/installatie#Z30Groep'
    ...
    def __init__(self):
        ...
        self.add_valid_relation(relation='https://wegenenverkeer.data.vlaanderen.be/ns/onderdeel#HoortBij', target='https://wegenenverkeer.data.vlaanderen.be/ns/onderdeel#DynBordExternePU', direction='i')  # i = direction: incoming
        self.add_valid_relation(relation='https://wegenenverkeer.data.vlaanderen.be/ns/onderdeel#HoortBij', target='https://wegenenverkeer.data.vlaanderen.be/ns/onderdeel#DynBordZ30', direction='i')  # i = direction: incoming
