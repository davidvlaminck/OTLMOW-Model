...
class Tegengewichtkist(ConstructiefObject, VlakGeometrie):
    """De tegengewichtkist is een stevige behuizing die deel uitmaakt van de macht-zijde van balans of een gebalanceerd, beweegbaar brugdeel. Vaak erdoor beschermd tegen nadelige atmosferische invloeden, is er massa (ballast) in ondergebracht om een (regelbaar) tegengewicht te bekomen."""

    typeURI = 'https://wegenenverkeer.data.vlaanderen.be/ns/installatie#Tegengewichtkist'
    ...
    def __init__(self):
        ...
        self._toegankelijkheid = OTLAttribuut(field=KlToegankelijkheid,
                                              ...
                                              objectUri='https://wegenenverkeer.data.vlaanderen.be/ns/installatie#Tegengewichtkist.toegankelijkheid',
                                              definition='Duidt de toegankelijkheid aan van het tegengewichtkist.',
                                              owner=self)

    @property
    def toegankelijkheid(self) -> str:
        """Duidt de toegankelijkheid aan van het tegengewichtkist."""
