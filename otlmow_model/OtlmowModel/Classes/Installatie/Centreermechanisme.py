...
class Centreermechanisme(Geleidingsmechanisme, AIMObject):
    ...
    def __init__(self):
        ...
        self.add_valid_relation(relation='https://wegenenverkeer.data.vlaanderen.be/ns/onderdeel#HoortBij', target='https://wegenenverkeer.data.vlaanderen.be/ns/onderdeel#Centreerstuk', direction='i')  # i = direction: incoming
