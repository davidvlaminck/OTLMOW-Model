...
class Koppelbalk(BalkGK):
    """Een balk die delen van een constructie met elkaar verbindt."""

    typeURI = 'https://wegenenverkeer.data.vlaanderen.be/ns/installatie#Koppelbalk'
    ...
    def __init__(self):
        ...
        self._heeftKraanrail = OTLAttribuut(field=BooleanField,
                                            naam='heeftKraanrail',
                                            label='heeft kraainrail',
                                            objectUri='https://wegenenverkeer.data.vlaanderen.be/ns/installatie#Koppelbalk.heeftKraanrail',
