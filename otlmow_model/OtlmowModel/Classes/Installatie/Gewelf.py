...
class Gewelf(ConstructieElementSluisStuw, ConstructiefObject, VlakGeometrie):
    """Gebogen structuur die de lasten van een constructie overbrengt naar de steunpunten (zoals pijlers, landhoofden, muren, etc.)"""

    typeURI = 'https://wegenenverkeer.data.vlaanderen.be/ns/installatie#Gewelf'
