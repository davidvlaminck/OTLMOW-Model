...
class Tunneluitrusting(NaampadObject, PuntGeometrie):
    """Generiek groepstype om alle types te groeperen die bij een koker horen."""

    typeURI = 'https://wegenenverkeer.data.vlaanderen.be/ns/installatie#Tunneluitrusting'
