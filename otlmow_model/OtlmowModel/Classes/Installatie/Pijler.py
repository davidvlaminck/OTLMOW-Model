...
class Pijler(AIMNaamObject, VlakGeometrie):
    ...
    def __init__(self):
        ...
        self.add_valid_relation(relation='https://wegenenverkeer.data.vlaanderen.be/ns/onderdeel#HoortBij', target='https://wegenenverkeer.data.vlaanderen.be/ns/installatie#Koppelbalk', direction='i')  # i = direction: incoming
        ...
        self._typeVerbinding = OTLAttribuut(field=KlTypeVerbinding,
                                            ...
                                            objectUri='https://wegenenverkeer.data.vlaanderen.be/ns/installatie#Pijler.typeVerbinding',
