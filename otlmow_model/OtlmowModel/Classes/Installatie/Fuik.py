...
class Fuik(AIMNaamObject, VlakGeometrie):
    """Overgangszone tussen het waterlichaam en de frontmuur per sluis of stuw."""

    typeURI = 'https://wegenenverkeer.data.vlaanderen.be/ns/installatie#Fuik'
    ...
    def __init__(self):
        ...
        self.add_valid_relation(relation='https://wegenenverkeer.data.vlaanderen.be/ns/onderdeel#HoortBij', target='https://wegenenverkeer.data.vlaanderen.be/ns/installatie#Geleidewerk', direction='i')  # i = direction: incoming
