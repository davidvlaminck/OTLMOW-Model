...
class Hameistijl(ConstructiefObject, PuntGeometrie):
    """Een hameistijl is een hoofdconstructieonderdeel van een beweegbare brug, type ophaalbrug. De verticale (kolom)structuur staat op de onderbouw, aan de scharnierzijde. Samen met een tweede hameistijl draagt het de balans die bovenaan scharnierend ermee verbonden is."""

    typeURI = 'https://wegenenverkeer.data.vlaanderen.be/ns/installatie#Hameistijl'
    ...
    def __init__(self):
        ...
        self._toegankelijkheid = OTLAttribuut(field=KlToegankelijkheid,
                                              ...
                                              objectUri='https://wegenenverkeer.data.vlaanderen.be/ns/installatie#Hameistijl.toegankelijkheid',
                                              definition='Duidt de toegankelijkheid aan van de hameistijl.',
                                              owner=self)

    @property
    def toegankelijkheid(self) -> str:
        """Duidt de toegankelijkheid aan van de hameistijl."""
