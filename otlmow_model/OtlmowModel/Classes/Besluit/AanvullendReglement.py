...
class AanvullendReglement(Besluit):
    ...
    def __init__(self):
        ...
        self.add_valid_relation(relation='http://todo.com/AanvullendReglement.isOntwerpVoor', target='https://data.vlaanderen.be/ns/mobiliteit#AanvullendReglementOntwerp', direction='i')  # i = direction: incoming
